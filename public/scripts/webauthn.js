...
// publicKeyCredentialCreationOptions comes from P1 MFA's CreateDevice (FIDO2) response
...
// publicKeyCredentialRequestOptions comes from P1 MFA's Create DeviceAuthN (FIDO2) response
